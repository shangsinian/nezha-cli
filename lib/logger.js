...
class Logger {
  ...
  success () {
    ...
    let ctext = '[success] ' + format.apply(null, arguments)
  ...
  notice () {
    ...
    let ctext = '[info] ' + format.apply(null, arguments)
  ...
  warning () {
    ...
    let ctext = '[warning] ' + format.apply(null, arguments)
  ...
  error () {
    ...
    let ctext ='[error] ' +  format.apply(null, arguments)
